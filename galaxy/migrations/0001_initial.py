# Generated by Django 3.2.16 on 2022-10-21 03:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('gfiles', '0002_alter_user_first_name'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('galaxyinstancetracking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='galaxy.galaxyinstancetracking')),
                ('genericfile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gfiles.genericfile')),
            ],
            options={
                'unique_together': {('galaxyinstancetracking', 'galaxy_id')},
            },
